...
LDLIBSOPTIONS=-lopencv_core -Wl,-rpath,../features/dist/Debug/GNU-Linux -L../features/dist/Debug/GNU-Linux -lgoon_features
...
${OBJECTDIR}/src/goon/data/base/Body.o: src/goon/data/base/Body.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/base/Body.o src/goon/data/base/Body.cpp

${OBJECTDIR}/src/goon/data/base/BodyUtils.o: src/goon/data/base/BodyUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/base
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/base/BodyUtils.o src/goon/data/base/BodyUtils.cpp

${OBJECTDIR}/src/goon/data/base/blob.o: src/goon/data/base/blob.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/base
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/base/blob.o src/goon/data/base/blob.cpp

${OBJECTDIR}/src/goon/data/base/region.o: src/goon/data/base/region.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/base
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/base/region.o src/goon/data/base/region.cpp

${OBJECTDIR}/src/goon/data/base/roi.o: src/goon/data/base/roi.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/base
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/base/roi.o src/goon/data/base/roi.cpp

${OBJECTDIR}/src/goon/data/capture.o: src/goon/data/capture.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/capture.o src/goon/data/capture.cpp

${OBJECTDIR}/src/goon/data/motion/Motion.o: src/goon/data/motion/Motion.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/motion
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/motion/Motion.o src/goon/data/motion/Motion.cpp

${OBJECTDIR}/src/goon/data/motion/Move.o: src/goon/data/motion/Move.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/motion
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/motion/Move.o src/goon/data/motion/Move.cpp

${OBJECTDIR}/src/goon/data/motion/Move2D.o: src/goon/data/motion/Move2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/motion
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/motion/Move2D.o src/goon/data/motion/Move2D.cpp

${OBJECTDIR}/src/goon/data/retina.o: src/goon/data/retina.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/retina.o src/goon/data/retina.cpp

${OBJECTDIR}/src/goon/data/rois.o: src/goon/data/rois.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/rois.o src/goon/data/rois.cpp

${OBJECTDIR}/src/goon/data/visual_data.o: src/goon/data/visual_data.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../features/src -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/visual_data.o src/goon/data/visual_data.cpp
