...
${OBJECTDIR}/src/goon/retinal/sdebug.o: src/goon/retinal/sdebug.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/retinal
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../vision_data/src -I../vision_utils/src -I/usr/include -I../show/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/retinal/sdebug.o src/goon/retinal/sdebug.cpp

${OBJECTDIR}/src/goon/retinal/segmentation3.o: src/goon/retinal/segmentation3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/retinal
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../vision_data/src -I../vision_utils/src -I/usr/include -I../show/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/retinal/segmentation3.o src/goon/retinal/segmentation3.cpp
