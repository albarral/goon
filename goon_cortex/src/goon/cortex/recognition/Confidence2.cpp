...
namespace goon
{
LoggerPtr Confidence2::logger(Logger::getLogger("goon.cortex.recognition.confidence"));
...
bool Confidence2::findConfidentMatches (CvSeq* seq_candidate_matches)
{
#ifdef DEBUG_MODE
	...
	showMatchesConfidence2 (seq_candidate_matches);
	...
	{		
		filterByConfidence2Ratio (seq_candidate_matches);
	}
...
void Confidence2::filterByConfidence2Ratio (CvSeq* seq_lmk_matches)
{	
#ifdef DEBUG_MODE
	cout << " init - FilterByConfidence2Ratio" << endl;	
#endif
	st_match match;
	...
	cvSeqSort (seq_lmk_matches, cmpMatchConfidence2, 0);
...
#ifdef DEBUG_MODE
	cout << " end - FilterByConfidence2Ratio" << endl;	
#endif
}
...
int Confidence2::cmpMatchConfidence2 ( const void* a, const void* b, void* userdata)
{
...
bool Confidence2::disambiguateConfidents (CvSeq* seq_winner_matches, st_match** pwinner_match)
{
#ifdef DEBUG_MODE
...
void Confidence2::showMatchesConfidence2 (CvSeq* seq_candidate_matches)
{
#ifdef DEBUG_MODE
	cout << " init - ShowMatchesConfidence2" << endl;
#endif
	st_match *match;

        LOG4CXX_DEBUG(logger, "Confidence2 ...");
...
#ifdef DEBUG_MODE
	cout << " end - ShowMatchesConfidence2" << endl;
#endif  
}
...
int Confidence2::getIdentifiedObject ()
{
	st_match *match;
...
void Confidence2::getRecognitionStatistics (int result)
{
#ifdef DEBUG_MODE
...
bool Confidence2::isRecognitionSafe ()
{
	bool bsafe;
	st_match *match;	
...
void Confidence2::showRecognitionStatistics ()
{
#ifdef DEBUG_MODE
