#ifndef __GOON_CORTEX_CONFIDENCE_H
#define __GOON_CORTEX_CONFIDENCE_H
...
private:
	void filterByConfidenceRatio (CvSeq* seq_lmk_matches);
	...
	static int cmpMatchConfidence ( const void* a, const void* b, void* userdata);
	...
	void showMatchesConfidence (CvSeq* seq_candidate_matches);
