...
namespace goon
{
LoggerPtr Coherence::logger(Logger::getLogger("goon.cortex.recognition.coherence"));	  

// Constructor
Coherence::Coherence (MemoryCenter* oMemoryCenter, int im_w, int im_h)
{
...
void Coherence::checkSelfCoherence (int lmk_size, int* lmk_global_position, CvSeq* seq_candidate_matches)
{
#ifdef DEBUG_MODE
	cout << " init - CheckSelfCoherence" << endl;
#endif
	st_match *match;
	st_object* object;
...
#ifdef DEBUG_MODE
	cout << " end - CheckSelfCoherence" << endl;
#endif
}
...
void Coherence::getLandmarkContext (CvSeq* seq_lmk_context, int* lmk_global_position, CvSeq* seq_recent_objects)
{
#ifdef DEBUG_MODE
...
void Coherence::checkGlobalCoherence (CvSeq* seq_lmk_context, CvSeq* seq_candidate_matches)
{
#ifdef DEBUG_MODE
	cout << " init - CheckGlobalCoherence" << endl;
#endif
	st_match *match;
	st_object* object;
...
#ifdef DEBUG_MODE
	cout << " end - CheckGlobalCoherence" << endl;
#endif  
}
...
float Coherence::compareContexts (CvSeq* seq_lmk_context, st_object* object)
{
#ifdef DEBUG_MODE
...
void Coherence::showContextList (CvSeq* seq_context)
{
#ifdef DEBUG_MODE
