...
${OBJECTDIR}/src/goon/cortex/data/Landmark.o: src/goon/cortex/data/Landmark.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/data/Landmark.o src/goon/cortex/data/Landmark.cpp

${OBJECTDIR}/src/goon/cortex/data/memory_center.o: src/goon/cortex/data/memory_center.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/cortex/data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/data/memory_center.o src/goon/cortex/data/memory_center.cpp

${OBJECTDIR}/src/goon/cortex/data/retinal_center.o: src/goon/cortex/data/retinal_center.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/cortex/data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/data/retinal_center.o src/goon/cortex/data/retinal_center.cpp
