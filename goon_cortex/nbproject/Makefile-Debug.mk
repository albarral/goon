...
${OBJECTDIR}/src/goon/cortex/recognition/Coherence2.o: src/goon/cortex/recognition/Coherence2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_data/src -I../goon_features/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/recognition/Coherence2.o src/goon/cortex/recognition/Coherence2.cpp

${OBJECTDIR}/src/goon/cortex/recognition/Confidence2.o: src/goon/cortex/recognition/Confidence2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/cortex/recognition
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_data/src -I../goon_features/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/recognition/Confidence2.o src/goon/cortex/recognition/Confidence2.cpp
