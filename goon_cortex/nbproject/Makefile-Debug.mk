...
${OBJECTDIR}/src/goon/cortex/recognition/Modeling.o: src/goon/cortex/recognition/Modeling.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/cortex/recognition
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_data/src -I../goon_features/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/cortex/recognition/Modeling.o src/goon/cortex/recognition/Modeling.cpp
