...
LDLIBSOPTIONS=-Wl,-rpath,../goon_core/dist/Debug/GNU-Linux -L../goon_core/dist/Debug/GNU-Linux -lgoon_core -Wl,-rpath,../../tron2/tron2_robot/dist/Debug/GNU-Linux -L../../tron2/tron2_robot/dist/Debug/GNU-Linux -ltron2_robot -Wl,-rpath,../../tron2/tron2_talky/dist/Debug/GNU-Linux -L../../tron2/tron2_talky/dist/Debug/GNU-Linux -ltron2_talky -Wl,-rpath,../../tron/tron_control/dist/Debug/GNU-Linux -L../../tron/tron_control/dist/Debug/GNU-Linux -ltron_control -Wl,-rpath,../../tron/tron_util/dist/Debug/GNU-Linux -L../../tron/tron_util/dist/Debug/GNU-Linux -ltron_util -Wl,-rpath,../../tron/tron_wire/dist/Debug/GNU-Linux -L../../tron/tron_wire/dist/Debug/GNU-Linux -ltron_wire -Wl,-rpath,../../tron/tron_wire2/dist/Debug/GNU-Linux -L../../tron/tron_wire2/dist/Debug/GNU-Linux -ltron_wire2 -Wl,-rpath,../../tron/tron_tools/dist/Debug/GNU-Linux -L../../tron/tron_tools/dist/Debug/GNU-Linux -ltron_tools

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../goon_core/dist/Debug/GNU-Linux/libgoon_core.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron2/tron2_robot/dist/Debug/GNU-Linux/libtron2_robot.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron2/tron2_talky/dist/Debug/GNU-Linux/libtron2_talky.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron/tron_control/dist/Debug/GNU-Linux/libtron_control.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron/tron_util/dist/Debug/GNU-Linux/libtron_util.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron/tron_wire/dist/Debug/GNU-Linux/libtron_wire.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron/tron_wire2/dist/Debug/GNU-Linux/libtron_wire2.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_coms2.${CND_DLIB_EXT}: ../../tron/tron_tools/dist/Debug/GNU-Linux/libtron_tools.so
...
${OBJECTDIR}/src/goon/coms/VisionComs.o: src/goon/coms/VisionComs.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../../tron2/tron2_robot/src -I../../tron2/tron2_talky/src -I../../tron/tron_control/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/coms/VisionComs.o src/goon/coms/VisionComs.cpp

${OBJECTDIR}/src/goon/coms/VisionConnector.o: src/goon/coms/VisionConnector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/coms
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../../tron2/tron2_robot/src -I../../tron2/tron2_talky/src -I../../tron/tron_control/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/coms/VisionConnector.o src/goon/coms/VisionConnector.cpp
...
${OBJECTDIR}/src/goon/coms/modules/VisionServer.o: src/goon/coms/modules/VisionServer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../../tron2/tron2_robot/src -I../../tron2/tron2_talky/src -I../../tron/tron_control/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/coms/modules/VisionServer.o src/goon/coms/modules/VisionServer.cpp
...
${OBJECTDIR}/src/goon/coms/server/ExtraChannelServer.o: src/goon/coms/server/ExtraChannelServer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../../tron2/tron2_robot/src -I../../tron2/tron2_talky/src -I../../tron/tron_control/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/coms/server/ExtraChannelServer.o src/goon/coms/server/ExtraChannelServer.cpp

${OBJECTDIR}/src/goon/coms/server/FocusChannelServer.o: src/goon/coms/server/FocusChannelServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/coms/server
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../../tron2/tron2_robot/src -I../../tron2/tron2_talky/src -I../../tron/tron_control/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/coms/server/FocusChannelServer.o src/goon/coms/server/FocusChannelServer.cpp
