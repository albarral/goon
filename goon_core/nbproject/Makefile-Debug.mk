...
${OBJECTDIR}/src/goon/core/Capture.o: src/goon/core/Capture.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_features/src -I../goon_data/src -I../../tron/tuly/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/core/Capture.o src/goon/core/Capture.cpp
