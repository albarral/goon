...
${OBJECTDIR}/src/goon/utils/Module.o: src/goon/utils/Module.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/Module.o src/goon/utils/Module.cpp

${OBJECTDIR}/src/goon/utils/angle.o: src/goon/utils/angle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/angle.o src/goon/utils/angle.cpp

${OBJECTDIR}/src/goon/utils/area.o: src/goon/utils/area.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/area.o src/goon/utils/area.cpp

${OBJECTDIR}/src/goon/utils/average.o: src/goon/utils/average.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/average.o src/goon/utils/average.cpp

${OBJECTDIR}/src/goon/utils/brooks/control.o: src/goon/utils/brooks/control.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/brooks/control.o src/goon/utils/brooks/control.cpp

${OBJECTDIR}/src/goon/utils/brooks/inhibition.o: src/goon/utils/brooks/inhibition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils/brooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/brooks/inhibition.o src/goon/utils/brooks/inhibition.cpp
...
${OBJECTDIR}/src/goon/utils/trigger.o: src/goon/utils/trigger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/utils/trigger.o src/goon/utils/trigger.cpp
