...
LDLIBSOPTIONS=-Wl,-rpath,../goon_core/dist/Debug/GNU-Linux -L../goon_core/dist/Debug/GNU-Linux -lgoon_core -Wl,-rpath,../goon_data/dist/Debug/GNU-Linux -L../goon_data/dist/Debug/GNU-Linux -lgoon_data -Wl,-rpath,../goon_features/dist/Debug/GNU-Linux -L../goon_features/dist/Debug/GNU-Linux -lgoon_features -Wl,-rpath,../goon_camera/dist/Debug/GNU-Linux -L../goon_camera/dist/Debug/GNU-Linux -lgoon_camera -Wl,-rpath,../goon_retinal/dist/Debug/GNU-Linux -L../goon_retinal/dist/Debug/GNU-Linux -lgoon_retinal -Wl,-rpath,../goon_peripheral/dist/Debug/GNU-Linux -L../goon_peripheral/dist/Debug/GNU-Linux -lgoon_peripheral -Wl,-rpath,../goon_cortex/dist/Debug/GNU-Linux -L../goon_cortex/dist/Debug/GNU-Linux -lgoon_cortex -Wl,-rpath,../../tron/tuly/dist/Debug/GNU-Linux -L../../tron/tuly/dist/Debug/GNU-Linux -ltron_tuly -Wl,-rpath,../../tron/maty/dist/Debug/GNU-Linux -L../../tron/maty/dist/Debug/GNU-Linux -ltron_maty -llog4cxx -lopencv_core -lopencv_highgui -lopencv_imgproc
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgoon_vision.${CND_DLIB_EXT}: ../goon_cortex/dist/Debug/GNU-Linux/libgoon_cortex.so
...
${OBJECTDIR}/src/goon/vision/VisionManager.o: src/goon/vision/VisionManager.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../goon_data/src -I../goon_features/src -I../goon_camera/src -I../goon_retinal/src -I../goon_peripheral/src -I../goon_cortex/src -I../../tron/tuly/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/vision/VisionManager.o src/goon/vision/VisionManager.cpp

${OBJECTDIR}/src/goon/vision/modules/Focus.o: src/goon/vision/modules/Focus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/vision/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../goon_data/src -I../goon_features/src -I../goon_camera/src -I../goon_retinal/src -I../goon_peripheral/src -I../goon_cortex/src -I../../tron/tuly/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/vision/modules/Focus.o src/goon/vision/modules/Focus.cpp

${OBJECTDIR}/src/goon/vision/modules/Grab.o: src/goon/vision/modules/Grab.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/vision/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../goon_data/src -I../goon_features/src -I../goon_camera/src -I../goon_retinal/src -I../goon_peripheral/src -I../goon_cortex/src -I../../tron/tuly/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/vision/modules/Grab.o src/goon/vision/modules/Grab.cpp

${OBJECTDIR}/src/goon/vision/modules/Look.o: src/goon/vision/modules/Look.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/vision/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../goon_data/src -I../goon_features/src -I../goon_camera/src -I../goon_retinal/src -I../goon_peripheral/src -I../goon_cortex/src -I../../tron/tuly/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/vision/modules/Look.o src/goon/vision/modules/Look.cpp

${OBJECTDIR}/src/goon/vision/modules/See.o: src/goon/vision/modules/See.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/vision/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../goon_core/src -I../goon_data/src -I../goon_features/src -I../goon_camera/src -I../goon_retinal/src -I../goon_peripheral/src -I../goon_cortex/src -I../../tron/tuly/src -I../../tron/maty/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/vision/modules/See.o src/goon/vision/modules/See.cpp
