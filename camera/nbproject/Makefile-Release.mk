...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libcamera.${CND_DLIB_EXT}
...
${OBJECTDIR}/src/goon/camera/camera.o: src/goon/camera/camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/camera
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/camera/camera.o src/goon/camera/camera.cpp
...
${OBJECTDIR}/src/goon/camera/models/image_flow.o: src/goon/camera/models/image_flow.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/camera/models/image_flow.o src/goon/camera/models/image_flow.cpp

${OBJECTDIR}/src/goon/camera/models/ip_camera.o: src/goon/camera/models/ip_camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/camera/models
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/camera/models/ip_camera.o src/goon/camera/models/ip_camera.cpp

${OBJECTDIR}/src/goon/camera/models/video_flow.o: src/goon/camera/models/video_flow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/camera/models
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/camera/models/video_flow.o src/goon/camera/models/video_flow.cpp

${OBJECTDIR}/src/goon/camera/models/web_camera.o: src/goon/camera/models/web_camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/camera/models
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/camera/models/web_camera.o src/goon/camera/models/web_camera.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libcamera.${CND_DLIB_EXT}
