...
${OBJECTDIR}/src/goon/data/cortex/Model.o: src/goon/data/cortex/Model.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/maty/src -I../goon_features/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/cortex/Model.o src/goon/data/cortex/Model.cpp
...
${OBJECTDIR}/src/goon/data/cortex/ObjectModel.o: src/goon/data/cortex/ObjectModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/goon/data/cortex
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/maty/src -I../goon_features/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/goon/data/cortex/ObjectModel.o src/goon/data/cortex/ObjectModel.cpp
